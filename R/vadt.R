    ...
    ui = navbarPage("vadt",
                    # Starting "Welcome" Tab"
                      tabPanel("Welcome",
                             ...
                             fluidRow(column(2),
                                      column(1,
                                             img(src = "http://mareframe.github.io/vat_documentation/images/MareFrame-Logo.jpg")),
                                      column(6),
                                      column(1,
                                             img(src = "http://mareframe.github.io/vat_documentation/images/eu.jpg", height = 45)),
                                      column(2))),
